            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden mt-auto">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="table-resposive-lg" style="height: 450px; overflow-y : scroll ;">
                        ...
                        <form id="add_room_form" autocomplete="off">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" min="1" name="children"
                                                class="form-control shadow-none" required />
                                        </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <div class="row">
                                                <?php
                                                $res = selectAll('choices');
                                                while ($opt = mysqli_fetch_assoc($res)) {
                                                    echo "
                                                        <div class='col-md-3 mb-1'>
                                                            <label>
                                                                <input type='checkbox' name='choices[]' value='{$opt['id']}' class='form-check-input shadow-none'>
                                                                {$opt['name']}
                                                            </label>
                                                        </div>";
                                                }
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit"
                                        class="btn-secondary custom-bg text-white shadow-none">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
